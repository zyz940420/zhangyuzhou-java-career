...
public final class MyRedisLockImpl implements MyRedisLock {
    ...
    private MyRedisLockImpl() {
        LuaScript.init();
    }

    private static MyRedisLockImpl instance = new MyRedisLockImpl();
    /**
     * 持有锁 成功标识
     */
    ...
    public static MyRedisLockImpl getInstance() {
        return instance;
    }
    ...
    public String lock(String lockKey, String requestID, int expireTime) {
        ...
        List<String> argsList = Arrays.asList(requestID, expireTime + "");
